...
public class loginSteps {
    ...
    public void userClicksOnDontHaveAccess() {
        driver = SetupDriver.getDriver();
        WebElement noaccess = driver.findElement(By.xpath("//*[@id=\"root\"]/div/main/div/div/div/div/div/div/div/div/div/div[2]/form/div[3]/div[1]/a"));
        if (noaccess.isDisplayed() && noaccess.getText().equals("Don't have an access?")) {
            System.out.println("I am on login page");
            noaccess.click();
        } else {
            System.out.println("Could not find login page");
